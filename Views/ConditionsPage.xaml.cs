...
public partial class ConditionsPage : ContentPage
{
    ...
    private async void OnBackTapped(object? sender, EventArgs e)
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine("[ConditionsPage] Успешно вернулись на страницу More");
        }
        catch (Exception ex)
        {
            System.Diagnostics.Debug.WriteLine($"[ConditionsPage] Ошибка навигации: {ex.Message}");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ConditionsPage] Альтернативный маршрут тоже не сработал: {ex2.Message}");
            }
        }
        finally
        {
