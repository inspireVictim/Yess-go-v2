...
public partial class PolicyPage : ContentPage
{
    ...
    private async void OnBackTapped(object? sender, EventArgs e)
    {
        try
        {
            ...
            System.Diagnostics.Debug.WriteLine("[PolicyPage] Успешно вернулись на страницу More");
        }
        catch (Exception ex)
        {
            System.Diagnostics.Debug.WriteLine($"[PolicyPage] Ошибка навигации: {ex.Message}");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[PolicyPage] Альтернативный маршрут тоже не сработал: {ex2.Message}");
            }
        }
        finally
        {
